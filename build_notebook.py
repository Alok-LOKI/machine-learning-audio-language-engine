...
# 2. Problem Statement
notebook["cells"].append(create_markdown_cell("""## Problem Statement
...
# 3. Dataset
notebook["cells"].append(create_markdown_cell("""## Dataset: WavCaps
...
setup_code = """# Install dependencies if necessary
...
notebook["cells"].append(create_code_cell(setup_code))

data_code = """# Load a small streaming subset of WavCaps (SoundBible subset)
...
notebook["cells"].append(create_code_cell(data_code))

# 4. Methodology
notebook["cells"].append(create_markdown_cell("""## Methodology
*   **Preprocessing**: 
...
# 5. Selected Models
notebook["cells"].append(create_markdown_cell("""## Selected Models
...
model_code = """# Preprocessing & Dataset definition
...
notebook["cells"].append(create_code_cell(model_code))

train_code = """# Training Loop (Contrastive Loss)
...
notebook["cells"].append(create_markdown_cell("""## Evaluation Criterion
...
notebook["cells"].append(create_code_cell(eval_code))

# 7. Results
notebook["cells"].append(create_markdown_cell("""## Results
...
notebook["cells"].append(create_markdown_cell("""## Error Analysis and Limitations
*   **Limitations**: 
...
error_analysis_code = """# Find a failure case (Rank > 1)
...
notebook["cells"].append(create_code_cell(error_analysis_code))

# 9. Conclusion
notebook["cells"].append(create_markdown_cell("""## Conclusion
...
with open('f:/MACHINE LEARN/Project_15_WavCaps.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=2)

print("Notebook generated successfully at f:/MACHINE LEARN/Project_15_WavCaps.ipynb")
